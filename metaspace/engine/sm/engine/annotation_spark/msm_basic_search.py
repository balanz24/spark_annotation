...
class MSMSearch:
    ...
    def search(self) -> Iterable[Tuple[pd.DataFrame, pyspark.RDD, FdrDiagnosticBundle]]:
        ...
        file.write(f"clip_and_segment_centroids: {time.time()-start}\n")
        ...
        file.write(f"select_target_formula_inds: {time.time()-start}\n")
        ...
        file.write(f"add_extra_data: {time.time()-start}")
        ...
        file.write(f"\ncreate_process_segment: {time.time()-start}\n")
        ...
        file.write(f"process_segments: {time.time()-start}\n")
        ...
        file.write(f"compute_fdr_and_filter_results: {time.time()-start}\n")
        file.close()
